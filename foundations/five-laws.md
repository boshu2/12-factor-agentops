...
Team B outperformed Team A by 10x within 6 months.
...
- Context that's obvious now won't be obvious in 6 months
...
```
6 months ago: Chose approach X after careful analysis
Today: Team member asks "Why X instead of Y?"
...
```
6 months ago: Chose approach X, documented in ADR
Today: Team member asks "Why X instead of Y?"
